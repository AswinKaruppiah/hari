...
export default function OurFacilities() {
    const features = [
        {
            label: "Bus Captain",
            description: "Professional bus captain will assist you throughout the journey.",
            icon: FaUserTie,
        },
        {
            label: "Boarding Crew",
            ...
            <div className="our-fecilities-sub-container">
                ...
                <div>
                    ...
                    <div className="features-section-right-text">
                        <p>
                            We believe that a comfortable journey begins with thoughtful services. From the moment you board,
                            our experienced crew ensures seamless transitions, curated comfort, and personalized.
                            our experienced crew ensures seamless.
                        </p>
                        <p>
                            Whether it's our trained boarding crew, smooth luggage handling, or our clean sleeper berths —
                            each feature is crafted to elevate your road travel experience.
                            each feature is crafted to elevate your road travel experience.
                        </p>
                    </div>
